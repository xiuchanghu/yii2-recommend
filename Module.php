...
{
    public $controllerNamespace = 'xiuchanghu\recommend\controllers\frontend';
    ...
    public function init()
    {
        ...
        if ($this->getIsBackend() === true) {
            ...
            $this->setViewPath('@xiuchanghu/recommend/views/frontend');
            $this->setLayoutPath('@xiuchanghu/recommend/views/frontend/layouts');
        }
    }
